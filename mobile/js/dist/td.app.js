...
angular
  ...
  .controller(
    'imgCrop',
    function ($scope, $state, $timeout, $localStorage, $cordovaCamera, Cropper, Camera, Upload, Users) {
      $scope.options = {
        maximize: true,
        aspectRatio: 1 / 1,
      ...
      ionic.on('$trudesk.imgcrop.setImage', function (data) {
        if (data.detail === undefined || data.detail.image === undefined)
          return console.log('Invalid data.detail.image');
        // hideCropper();
