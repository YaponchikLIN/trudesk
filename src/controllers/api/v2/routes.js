...
module.exports = function (middleware, router, controllers) {
  ...
  router.post('/api/v2/accounts/notificationToken', apiv2.accounts.saveNotificationToken);
  // Ticket Info
  ...
  router.get('/api/v2/tickets/:uid/:userEmail', apiv2Auth, canUser('tickets:view'), apiv2.tickets.single);
  ...
  //watchers
  router.post('/api/v2/watchers', apiv2Auth, apiv2.watchers.get);
  router.post('/api/v2/watchers/check', apiv2Auth, apiv2.watchers.check);
  router.post('/api/v2/watchers/add', apiv2Auth, apiv2.watchers.add);
  router.post('/api/v2/watchers/update', apiv2Auth, apiv2.watchers.update);
  router.post('/api/v2/watchers/remove', apiv2Auth, apiv2.watchers.remove);


  //TCM
  router.get('/api/v2/tcms', apiv2Auth, apiv2.tcms.get);

  //tSortings
  router.get('/api/v2/tSortings', apiv2Auth, apiv2.tSortings.get);
  ...
  router.post('/api/v2/blacklist/add', apiv2Auth, apiv2.blacklist.add);
  router.post('/api/v2/blacklist/update', apiv2Auth, apiv2.blacklist.update);
  router.delete('/api/v2/blacklist/remove/:id', apiv2Auth, apiv2.blacklist.remove);
  // Groups
