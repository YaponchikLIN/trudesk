  ...
  async.waterfall(
    [
      ...
      function (grps, callback) {
        ...
        ticketModel.getTicketsWithObjectForMobile(grps, object, function (err, results) {
...
apiTickets.postComment = function (req, res) {
  ...
  ticketModel.getTicketById(ticketId, function (err, t) {
    ...
    forMailComment = sanitizeHtml(xss(marked.parse(comment))).trim();
    ...
    t.save(function (err, tt) {
      ...
      if (!commentJson.attachments) {
        ...
        emitter.emit('ticket:comment:added', tt, CommentForMail, req.headers.host);
      }
