...
module.exports = function (middleware, router, controllers) {
  ...
  router.put('/api/v1/settings/mailer/template/:id/fullHTML', apiv1, isAdmin, apiCtrl.settings.updateTemplateFullHTML);
  ...
  router.post('/api/v1/settings/general/firebaseMessagingSw', apiv1, isAdmin, apiCtrl.settings.firebaseMessagingSw);
  router.post('/api/v1/settings/general/fileServiceAccount', apiv1, isAdmin, apiCtrl.settings.fileServiceAccount);
  router.post('/api/v1/settings/general/fileImage', apiv1, isAdmin, apiCtrl.settings.fileImage);
  router.get(
    '/api/v1/settings/general/checkFileServiceAccount',
    apiv1,
    isAdmin,
    apiCtrl.settings.checkFileServiceAccount
  );
  router.get('/api/v1/settings/general/firebaseConfig', apiv1, apiCtrl.settings.firebaseConfig);
