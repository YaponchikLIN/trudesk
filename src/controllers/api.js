...
apiController.v2.ldapGroups = require('./api/v2/ldapGroups');
...
apiController.v2.tcms = require('./api/v2/tcms');
apiController.v2.tSortings = require('./api/v2/tSortings');
apiController.v2.blacklist = require('./api/v2/blacklist');
apiController.v2.watchers = require('./api/v2/watchers');
