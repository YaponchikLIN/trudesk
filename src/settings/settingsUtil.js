  ...
  return new Promise((resolve, reject) => {
    (async () => {
      try {
        ...
        s.timeFormat = parseSetting(settings, 'gen:timeFormat', 'HH:mm');
        ...
        s.apiKey = parseSetting(settings, 'gen:apiKey', '');
        s.authDomain = parseSetting(settings, 'gen:authDomain', '');
        s.projectId = parseSetting(settings, 'gen:projectId', '');
        s.storageBucket = parseSetting(settings, 'gen:storageBucket', '');
        s.messagingSenderId = parseSetting(settings, 'gen:messagingSenderId', '');
        s.appId = parseSetting(settings, 'gen:appId', '');
        s.vapidKey = parseSetting(settings, 'gen:vapidKey', '');
        ...
        s.ldapPathToGroups = parseSetting(settings, 'ldapSettings:pathToGroups', '');
        s.ldapSearchBase = parseSetting(settings, 'ldapSettings:searchBase', '');
        s.ldapAuthorizationDomains = parseSetting(settings, 'ldapSettings:authorizationDomains', '');
        ...
        s.chatwootStatusChangeMessageTemplate = parseSetting(
          settings,
          'chatwootSettings:statusChangeMessageTemplate',
          ''
        );
