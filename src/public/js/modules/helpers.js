...
define([
  ...
  //       console.log('value validiatorFunction: ' + value)
  ...
  //   if (date && (format == 'hh:mm' || format == 'YYYY-MM-DD HH:mm' || format == 'DD MMM YYYY, hh:mm')) {
  ...
  //       if (isUTC) {
  //         partDate = moment(date).utc(true).tz(timezone).format('YYYY-MM-DD')
  //       } else {
  //         partDate = moment(date).tz(timezone).format('YYYY-MM-DD')
  //       }

  //       formatted = partDate + formatted

  //     } else if (format == 'DD MMM YYYY, hh:mm') {

  //       if (isUTC) {
  //         partDate = moment(date).utc(true).tz(timezone).format('DD MMM YYYY')
  //       } else {
  //         partDate = moment(date).tz(timezone).format('DD MMM YYYY')
  //       }
  ...
  helpers.setupTruTabs = function (tabs) {
    var toggleTab = function (element) {
      ...
      $(element).on('click', function (event) {
        ...
        function changeActive(elementThis) {
          if (elementThis.hasClass('active')) return true;

          var $highlighter = elementThis.parent().find('.tru-tab-highlighter');
          ...
          elementThis.addClass('active');
          $highlighter.css({ width: elementThis.outerWidth() });

          var tabId = elementThis.attr('data-tabid');
          ...
          var highlighterPos = elementThis.position().left + 'px';
        ...
        if (parentId !== 'post') {
          let elementSelectors = document.querySelector('.tru-tab-selectors#post');
          let elementThis;
          if ($(this).attr('data-tabid') == 0 || $(this).attr('data-tabid') == 1) {
            elementThis = elementSelectors.querySelector(`[data-tabid="0"]`);
          } else if ($(this).attr('data-tabid') == 2) {
            elementThis = elementSelectors.querySelector(`[data-tabid="1"]`);
          }

          changeActive($(elementThis));
        }
      });
