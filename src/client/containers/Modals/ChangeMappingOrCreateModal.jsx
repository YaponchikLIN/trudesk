        ...
        <div style={{ margin: ' 0px 25px 0px' }}>
          <div className="uk-modal-footer uk-text-center">
            <a
              ...
              href={`${siteURL}/loginChatwoot?username=${this.username}&phone=${this.phone}&email=${this.email}&contactID=${this.contactID}&accountID=${this.accountID}&customAttributes=${this.customAttributes}&fullname=${this.fullname}`}
            >
              Create User
            </a>
            <a
              ...
              href={`${siteURL}/mappingChatwoot?username=${this.username}&phone=${this.phone}&email=${this.email}&contactID=${this.contactID}&accountID=${this.accountID}&customAttributes=${this.customAttributes}`}
            >
              User Mapping
            </a>
          </div>
