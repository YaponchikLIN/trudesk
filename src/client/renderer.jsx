...
export default function (store) {
  ...
  if (document.getElementById('tickets-container')) {
    ...
    let sort = document.getElementById('tickets-container').getAttribute('data-sort');
    sort = sort ? JSON.parse(sort) : {};

    const TicketsContainerWithProvider = (
      <Provider store={store}>
        <TicketsContainer view={view} page={page} filter={filter} sort={sort} />
      </Provider>
    );
  ...
  if (document.getElementById('single-ticket-container')) {
    ...
    const sessionUserEmail = document
      .getElementById('single-ticket-container')
      .getAttribute('data-ticket-sessionUserEmail');
    const SingleTicketContainerWithProvider = (
      <Provider store={store}>
        <SingleTicketContainer ticketId={ticketId} ticketUid={ticketUid} sessionUserEmail={sessionUserEmail} />
      </Provider>
    );
  ...
  if (document.getElementById('changeMappingOrCreate-container')) {
    ...
    const customAttributes = document
      .getElementById('changeMappingOrCreate-container')
      .getAttribute('data-customAttributes');
    ...
    ReactDOM.render(
      ChangeMappingOrCreateModalContainerWithProvider,
      document.getElementById('changeMappingOrCreate-container')
    );
  }
  ...
  if (document.getElementById('createTicketFromChatwoot-container')) {
    ...
    const conversationID = document
      .getElementById('createTicketFromChatwoot-container')
      .getAttribute('data-conversationID');
    ...
    ReactDOM.render(
      CreateTicketFromChatwootModalContainerWithProvider,
      document.getElementById('createTicketFromChatwoot-container')
    );
  }
