...
export const FETCH_WATCHERS = defineAction('FETCH_WATCHERS', [SUCCESS, PENDING, ERROR]);
export const SET_CURRENT_TICKET = defineAction('SET_CURRENT_TICKET', [SUCCESS]);
...
export const CLEARSTATE_ACCOUNTS = defineAction('CLEARSTATE_ACCOUNTS', [PENDING, SUCCESS, ERROR]);
...
export const CREATE_ACCOUNTFROMCHATWOOT = defineAction('CREATE_ACCOUNTFROMCHATWOOT', [PENDING, SUCCESS, ERROR]);
...
export const CREATE_CHATWOOTDATA = defineAction('CREATE_CHATWOOTDATA', [SUCCESS, PENDING, ERROR]);
export const UPDATE_CHATWOOTDATA = defineAction('UPDATE_CHATWOOTDATA', [SUCCESS, PENDING, ERROR]);
export const DELETE_CHATWOOTDATA = defineAction('DELETE_CHATWOOTDATA', [SUCCESS, PENDING, ERROR]);
export const UNLOAD_CHATWOOTDATA = defineAction('UNLOAD_CHATWOOTDATA', [SUCCESS]);
export const REQUEST_CHATWOOTDATA = defineAction('REQUEST_CHATWOOTDATA ', [SUCCESS]);
