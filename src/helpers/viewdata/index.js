      ...
      function (callback) {
        async.parallel(
          [
            ...
            function (done) {
              settingSchema.getSetting('gen:apiKey', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.apiKey = setting.value;
                } else {
                  viewdata.apiKey = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:authDomain', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.authDomain = setting.value;
                } else {
                  viewdata.authDomain = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:projectId', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.projectId = setting.value;
                } else {
                  viewdata.projectId = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:storageBucket', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.storageBucket = setting.value;
                } else {
                  viewdata.storageBucket = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:messagingSenderId', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.messagingSenderId = setting.value;
                } else {
                  viewdata.messagingSenderId = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:appId', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.appId = setting.value;
                } else {
                  viewdata.appId = '';
                }
            ...
            function (done) {
              settingSchema.getSetting('gen:vapidKey', function (err, setting) {
                if (!err && setting && setting.value) {
                  viewdata.vapidKey = setting.value;
                } else {
                  viewdata.vapidKey = '';
                }
